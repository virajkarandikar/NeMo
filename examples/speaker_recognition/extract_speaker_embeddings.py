...
def main():
    ...
    if args.model_path.endswith('.nemo'):
        ...
        speaker_model = ExtractSpeakerEmbeddingsModel.from_pretrained('speakerverification_speakernet')
        logging.info(f"using NGC pretrained speaker verification model from NGC")
