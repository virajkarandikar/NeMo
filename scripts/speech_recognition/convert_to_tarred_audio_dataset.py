...
parser.add_argument(
    "--dataset_dir", default=None, type=str, required=False, help="Path to the dataset's directory."
)
    ...
    def _create_shard(self, entries, target_dir, shard_id):
        ...
        for entry in entries:
            ...
            if squashed_filename not in count:
                tar.add(os.path.join(args.dataset_dir,entry['audio_filepath']), arcname=squashed_filename)
